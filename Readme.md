...
* Студент: [Виталий Потросов](https://up.htmlacademy.ru/php/10/user/796623).
...
На настоящий день SMTP-данные для библиотеки SwiftMailer устарели, в сязи с чем
с 14.11.2019 функция отправки писем отключена (закомментирован код в файле notify.php).

Для нормального функционирования проекта на вашем компьютере должен быть установлен composer.
